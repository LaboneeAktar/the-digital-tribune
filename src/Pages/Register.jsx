          ...
          <form onSubmit={handleSubmit} className="space-y-12 px-10">
            <div className="space-y-4">
              ...
              <div className="space-y-4 flex flex-col justify-center items-center pt-2">
                ...
                >
                  <span className="w-full h-52 rounded rotate-[-40deg] bg-[#D72050] absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
