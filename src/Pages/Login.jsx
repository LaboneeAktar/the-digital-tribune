  ...
  return (
    <div>
      <div className="min-h-screen flex justify-center items-center">
        <div className="flex flex-col w-xl px-6 rounded-md lg:px-10 lg:py-12 bg-gray-50 mt-0 dark:text-gray-800">
          ...
          <form noValidate="" action="" className="space-y-12 px-10">
